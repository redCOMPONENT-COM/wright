...
<div class="newsflash-horiz<?php echo $params->get('moduleclass_sfx'); // Wright v.3: Changed ul for div element ?>">
	<?php for ($i = 0, $n = count($list); $i < $n; $i ++) :
		...
		<?php // Wright v.3: Added row for each horizontal set of columns ?>
			<?php if ($c % $wrightMaxColumns ==  0):?>
				<div class="row">
			<?php endif; ?>
		<?php // End Wright v.3: Added row for each horizontal set of columns ?>

			<div class="col-md-<?php echo $span ?>"> <?php // Wright v.3: Added span class for each column ?>
