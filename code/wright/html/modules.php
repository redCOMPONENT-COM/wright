...
/**
 * Wright Flex Grid
 * (i.e. <w:module type="{row/row}" name="position" chrome="wrightflexgrid" extradivs="{optional}" extraclass="{optional}" />
 */
function modChrome_wrightflexgrid($module, &$params, &$attribs) 
{
	...
	$extradivs = (!empty($attribs['extradivs']) ? ' ' . $attribs['extradivs'] : '');
	
	$extraclass = (!empty($attribs['extraclass']) ? ' ' . $attribs['extraclass'] : '');
...
<?php
	...
	if ($module->showtitle) : ?>
	<?php if (!empty($extradivs) && in_array('title',$extradivs)) : ?>	<div class="module_title"> <?php endif; ?>
	<?php echo $moduleTitle; ?>
	<?php if (!empty($extradivs) && in_array('in-title',$extradivs)) : ?> <div class="module_title_in"></div> <?php endif; ?>
	<?php if (!empty($extradivs) && in_array('title',$extradivs)) : ?>	</div> <?php endif; ?>
<?php endif; ?>
<?php
	echo $module->content;
	if ($featured)
