...
<div class="newsflash-horiz<?php echo $params->get('moduleclass_sfx'); // Wright v.3: Changed ul for div element ?>">
	<?php for ($i = 0, $n = count($list); $i < $n; $i ++) :
		...
		<?php // Wright v.3: Added row for each horizontal set of 4 columns ?>
			<?php if ($cont % 4 ==  0):?>
				<div class="row">
			<?php endif; ?>
		<?php // End Wright v.3: Added row for each horizontal set of 4 columns ?>

			<div class="col-md-3"> 		<?php // Wright v.3: Added span3 class for each column ?>
