...
<?php if (!empty($this->intro_items)) : ?>
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<div class="items-row cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$row; ?> row<?php echo ($this->wrightIntroRowsClass != '' ? ' ' . $this->wrightIntroRowsClass : ''); // Wright v.3: Intro Rows Class ?>">
		<?php endif; ?>
